...
// Establecer la ruta del worker usando una version específica
// que sabemos que está disponible en CDN
const PDFJS_CDN = 'https://cdnjs.cloudflare.com/ajax/libs/pdf.js/2.16.105/pdf.worker.min.js';
...
export async function extractTextFromPDF(pdfFile, progressCallback = () => {}) {
  try {
    ...
    // Cargar el documento con opciones específicas para mejor extracción de texto
